        ...
        <form @submit.prevent="login">
          ...
          <div :class="{on: !loginWay}">
            <section>
              ...
              <section class="login_verification">
                <input type="text" maxlength="8" placeholder="密码" v-if="showPwd" v-model.trim="pwd">
                <input type="password" maxlength="8" placeholder="密码" v-else v-model.trim="pwd">
